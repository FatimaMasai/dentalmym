...
<div class="br-pagebody">
    <div class="br-section-wrapper">
        <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Editar Proveedor</h6>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label for="x_card_code" class="control-label mb-1">  PROVEEDOR</label>
                                <select name="id_persona" value="{{$proveedor->persona->nombre}}"  id="id_persona" class="form-control"> 
